...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Profile.status'
        db.alter_column(u'ratings_profile', 'status', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Profile.rep'
        db.alter_column(u'ratings_profile', 'rep', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'ratings.profile': {
            ...
            'rep': ('django.db.models.fields.CharField', [], {'default': "'underperformed'", 'max_length': '20'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'lowly'", 'max_length': '20'})
        },
