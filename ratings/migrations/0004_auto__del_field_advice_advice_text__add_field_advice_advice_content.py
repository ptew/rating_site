...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Advice.advice_text'
        db.delete_column(u'ratings_advice', 'advice_text')

        # Adding field 'Advice.advice_content'
        db.add_column(u'ratings_advice', 'advice_content',
                      self.gf('django.db.models.fields.CharField')(default='content', max_length=1000),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Advice.advice_text'
        db.add_column(u'ratings_advice', 'advice_text',
    ...
    models = {
        u'ratings.advice': {
            ...
            'advice_content': ('django.db.models.fields.CharField', [], {'max_length': '1000'}),
